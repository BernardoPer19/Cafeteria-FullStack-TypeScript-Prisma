...
function About() {
  return (
    <main className="bg-orange-100 w-full h-[70vh]">
      <div className="relative max-w-[1200px] m-auto w-full h-full flex items-center justify-center">
        <div className="flex gap-5 mr-96 max-[768px]:flex-col max-[768px]:gap-4 max-[768px]:mr-0 max-[768px]:w-full max-[768px]:justify-center">
          ...
          <img
            ...
            alt="Imagen 1"
            className="w-80 h-[500px] object-cover bg-blue-50 max-[768px]:w-full max-[768px]:h-[400px] max-[768px]:mb-4" // Aumentar la altura y agregar margen inferior
          />
          ...
          <img
            ...
            alt="Imagen 2"
            className="hidden max-[768px]:hidden md:block w-80 h-[500px] object-cover bg-blue-50 max-[768px]:w-full max-[768px]:h-[400px]"
          />
        </div>

        <div className="absolute right-1 bg-white w-[600px] p-6 rounded-lg shadow-lg max-[768px]:w-full max-[768px]:p-4 max-[768px]:left-1/2 max-[768px]:transform max-[768px]:-translate-x-1/2 max-[768px]:bottom-5 max-[768px]:mt-4"> {/* Agregar margen superior */}
          <h1 className={`text-3xl text-amber-500 mb-4 ${sora.variable} max-[768px]:text-xl`}>
            Sobre Coffee-Events
          </h1>
          <p className={`text-base font-semibold ${sora.variable} max-[768px]:text-sm`}>
