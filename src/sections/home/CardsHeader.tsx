...
function CardsHeader() {
  return (
    <main className="h-auto p-6 bg-[#e1d6c6]">
      ...
      <div className="flex items-center p-3 bg-coffee-light gap-2 rounded-lg shadow-sm text-center">
      ...
      <div className="flex items-center p-3 bg-coffee-light rounded-lg shadow-sm text-center gap-2">
